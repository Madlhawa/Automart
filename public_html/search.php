			...
			<div id="sidebar">
				...
				<table id="form">
					...
					<tr>
						...
						<tr>
							<td><input type="text" style="width:340px;" name="model" value="Model"></td>
						</tr>
					<tr>
						<td>
...
<?php
	...
	if($_POST)
	{
		...
		$sql="SELECT * FROM car WHERE make like '%$newmake%' and year like '%$newyear%' and status like '%$newstatus%' and transmision like '%$newtransmition%' and model like '%$newmodel%'";
